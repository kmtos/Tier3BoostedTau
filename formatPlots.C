...
//   weightsMCData.push_back(1.0); //W + jets already weighted to 19.7 fb^-1
  ...
  string dataIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis" + MTBin + "_SingleMu" + dataSuffix); //BLINDED!!!
  string dataNonIsoPrefix(analysisFilePath + "data/analysis/muHadNonIsoAnalysis" + MTBin + "_SingleMu");
  string dataNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis" + MTBin + "_SingleMu"+ dataSuffix);
  string dataNonIsoReweightPrefix(analysisFilePath + 
				  "data/analysis/muHadNonIsoReweightAnalysis_SingleMu");
  string dataNonIsoReweightHaddOutputFile( analysisFilePathOut + "muHadNonIsoReweightAnalysis_SingleMu" + dataSuffix);
  string dataAllPrefix(analysisFilePath + "data/analysis/muHadAnalysis" + MTBin + "_SingleMu");
  string dataAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis" + MTBin + "_SingleMu" + dataSuffix); //BLINDED!!!
...
// 		 nullBlindLow, nullBlindHigh);
  ...
  string nonIsoWDataIsoHaddOutputFile(analysisFilePathOut + "nonIsoW_muHadIsoAnalysis" + MTBin + "_SingleMu" + nonIsoWDataSuffix);
  string nonIsoWDataNonIsoPrefix(analysisFilePath + 
				 "nonIsoWData/analysis/nonIsoW_muHadNonIsoAnalysis" + MTBin + "_SingleMu");
  string nonIsoWDataNonIsoHaddOutputFile(analysisFilePathOut + "nonIsoW_muHadNonIsoAnalysis" + MTBin + "_SingleMu" + nonIsoWDataSuffix);
  ...
  string nonIsoWDataNonIsoReweightHaddOutputFile(analysisFilePathOut + "nonIsoW_muHadNonIsoReweightAnalysis_SingleMu" + 
						 nonIsoWDataSuffix);
  string nonIsoWDataAllPrefix(analysisFilePath + "nonIsoWData/analysis/nonIsoW_muHadAnalysis" + MTBin + "_SingleMu");
  string nonIsoWDataAllHaddOutputFile(analysisFilePathOut + "nonIsoW_muHadAnalysis" + MTBin + "_SingleMu"+ nonIsoWDataSuffix);
...
*/
  ...
  string ggIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis" + MTBin + uncTag + "_gg_a9" + "_hadd" + ggSuffix);
  string ggAllPrefix(analysisFilePath + "gg/muHadAnalysis" + MTBin + uncTag + "_gg_a9");
  string ggAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis" + MTBin + uncTag + "_gg_a9" + "_hadd" + ggSuffix);
...
*/
  ...
  string DYJetsToLLIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis" + MTBin + "_DYJetsToLL" + DYJetsToLLSuffix);
  string DYJetsToLLNonIsoPrefix(analysisFilePath + 
				"DYJetsToLL/analysis/muHadNonIsoAnalysis" + MTBin + "_DYJetsToLL");
  string DYJetsToLLNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis" + MTBin + "_DYJetsToLL" + DYJetsToLLSuffix);
  string 
    DYJetsToLLNonIsoReweightPrefix(analysisFilePath + 
				   "DYJetsToLL/analysis/muHadNonIsoReweightAnalysis_DYJetsToLL");
  string DYJetsToLLNonIsoReweightHaddOutputFile(analysisFilePathOut + "muHadNonIsoReweightAnalysis_DYJetsToLL" + DYJetsToLLSuffix);
  string DYJetsToLLAllPrefix(analysisFilePath + "DYJetsToLL/analysis/muHadAnalysis" + MTBin + "_DYJetsToLL");
  string DYJetsToLLAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis" + MTBin + "_DYJetsToLL" + DYJetsToLLSuffix);
...
// 		 nullBlindLow, nullBlindHigh);
  ...
  string TTJetsIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis" + MTBin + "_TTJets" + "_hadd" + TTJetsSuffix);
  string TTJetsNonIsoPrefix(analysisFilePath + "TTJets/analysis/muHadNonIsoAnalysis" + MTBin + "_TTJets");
  string TTJetsNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis" + MTBin + "_TTJets" + "_hadd" + TTJetsSuffix);
  string TTJetsNonIsoReweightPrefix(analysisFilePath + 
				    "TTJets/analysis/muHadNonIsoReweightAnalysis_TTJets");
  string TTJetsNonIsoReweightHaddOutputFile(analysisFilePathOut + "muHadNonIsoReweightAnalysis_TTJets" + "_hadd" + TTJetsSuffix);
  string TTJetsAllPrefix(analysisFilePath + "TTJets/analysis/muHadAnalysis" + MTBin + "_TTJets");
  string TTJetsAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis" + MTBin + "_TTJets" + "_hadd" + TTJetsSuffix);
...
// 		 canvasNames2D, graphNames2D, nullBlindLow, nullBlindHigh);
  ...
  string TIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis" + MTBin + "_T" + TSuffix);
  string TNonIsoPrefix(analysisFilePath + "SingleTop/analysis/muHadNonIsoAnalysis" + MTBin + "_T");
  string TNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis" + MTBin + "_T" + TSuffix);
  string TNonIsoReweightPrefix(analysisFilePath + 
			       "SingleTop/analysis/muHadNonIsoReweightAnalysis_T");
  string TNonIsoReweightHaddOutputFile(analysisFilePathOut + "muHadNonIsoReweightAnalysis_T" + TSuffix);
  string TAllPrefix(analysisFilePath + "SingleTop/analysis/muHadAnalysis" + MTBin + "_T");
  string TAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis" + MTBin + "_T" + TSuffix);
...
// 		 nullBlindHigh);
  ...
  string WNJetsToLNuIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis" + MTBin + "_W" + "N" + WNJetsToLNuSuffix);
  string WNJetsToLNuNonIsoPrefix(analysisFilePath + "WNJetsToLNu/analysis/muHadNonIsoAnalysis" + MTBin + "_W");
  string WNJetsToLNuNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis" + MTBin + "_W" + "N" + WNJetsToLNuSuffix);
  string WNJetsToLNuNonIsoReweightPrefix(analysisFilePath + 
					 "WNJetsToLNu/analysis/muHadNonIsoReweightAnalysis_W");
  string WNJetsToLNuNonIsoReweightHaddOutputFile(analysisFilePathOut + "muHadNonIsoReweightAnalysis_W" + "N" + 
						 WNJetsToLNuSuffix);
  string WNJetsToLNuAllTauPrefix(analysisFilePath + "WNJetsToLNu/analysis/muHadAnalysis" + MTBin + "_W");
  string WNJetsToLNuAllTauHaddOutputFile(analysisFilePathOut + "muHadAnalysis" + MTBin + "_W" + "N" + WNJetsToLNuSuffix);
...
// 		 graphNames2D, nullBlindLow, nullBlindHigh);
  ...
  string WbbIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis_Wbb" + "_hadd" + WbbSuffix);
  string WbbNonIsoPrefix(analysisFilePath + "Wbb/analysis/muHadNonIsoAnalysis_Wbb");
  string WbbNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis_Wbb" + "_hadd" + WbbSuffix);
  string 
    WbbNonIsoReweightPrefix(analysisFilePath + "Wbb/analysis/muHadNonIsoReweightAnalysis_Wbb");
  string WbbNonIsoReweightHaddOutputFile(analysisFilePathOut + "muHadNonIsoReweightAnalysis_Wbb" + "_hadd" + WbbSuffix);
  string WbbAllPrefix(analysisFilePath + "Wbb/analysis/muHadAnalysis_Wbb");
  string WbbAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis_Wbb" + "_hadd" + WbbSuffix);
  ...
  string WJetsToLNuIsoHaddOutputFile(analysisFilePathOut  + "muHadIsoAnalysis_WJetsToLNu"+ "_hadd" + WJetsToLNuSuffix);
  string WJetsToLNuNonIsoPrefix(analysisFilePath + 
				"WJetsToLNu/analysis/muHadNonIsoAnalysis_WJetsToLNu");
  string WJetsToLNuNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis_WJetsToLNu" + "_hadd" + WJetsToLNuSuffix);
  string 
    WJetsToLNuNonIsoReweightPrefix(analysisFilePath + 
				   "WJetsToLNu/analysis/muHadNonIsoReweightAnalysis_WJetsToLNu");
  string WJetsToLNuNonIsoReweightHaddOutputFile(analysisFilePathOut + "muHadNonIsoReweightAnalysis_WJetsToLNu" + "_hadd" + 
						WJetsToLNuSuffix);
  string WJetsToLNuAllPrefix(analysisFilePath + "WJetsToLNu/analysis/muHadAnalysis_WJetsToLNu");
  string WJetsToLNuAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis_WJetsToLNu" + "_hadd" + WJetsToLNuSuffix);
  ...
  string WZIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis" + MTBin + "_WZ" + "_hadd" + WZSuffix);
  string WZNonIsoPrefix(analysisFilePath + "WZ/analysis/muHadNonIsoAnalysis" + MTBin + "_WZ");
  string WZNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis" + MTBin + "_WZ" + "_hadd" + WZSuffix);
  string WZNonIsoReweightPrefix(analysisFilePath + "WZ/analysis/muHadNonIsoReweightAnalysis_WZ");
  string WZNonIsoReweightHaddOutputFile(analysisFilePathOut + "muHadNonIsoReweightAnalysis_WZ" + "_hadd" + WZSuffix);
  string WZAllPrefix(analysisFilePath + "WZ/analysis/muHadAnalysis" + MTBin + "_WZ");
  string WZAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis" + MTBin + "_WZ" + "_hadd" + WZSuffix);
...
// 		 canvasNames2D, graphNames2D, nullBlindLow, nullBlindHigh);
  ...
  string ZZIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis" + MTBin + "_ZZ" + "_hadd" + ZZSuffix);
  string ZZNonIsoPrefix(analysisFilePath + "ZZ/analysis/muHadNonIsoAnalysis" + MTBin + "_ZZ");
  string ZZNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis" + MTBin + "_ZZ" + "_hadd" + ZZSuffix);
  string ZZNonIsoReweightPrefix(analysisFilePath + "ZZ/analysis/muHadNonIsoReweightAnalysis_ZZ");
  string ZZNonIsoReweightHaddOutputFile(analysisFilePathOut + "muHadNonIsoReweightAnalysis_ZZ" + "_hadd" + ZZSuffix);
  string ZZAllPrefix(analysisFilePath + "ZZ/analysis/muHadAnalysis" + MTBin + "_ZZ");
  string ZZAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis" + MTBin + "_ZZ" + "_hadd" + ZZSuffix);
...
// 		 canvasNames2D, graphNames2D, nullBlindLow, nullBlindHigh);
  ...
  string WWIsoHaddOutputFile(analysisFilePathOut + "muHadIsoAnalysis" + MTBin + "_WW" + "_hadd" + WWSuffix);
  string WWNonIsoPrefix(analysisFilePath + "WW/analysis/muHadNonIsoAnalysis" + MTBin + "_WW");
  string WWNonIsoHaddOutputFile(analysisFilePathOut + "muHadNonIsoAnalysis" + MTBin + "_WW" + "_hadd" + WWSuffix);
  string WWNonIsoReweightPrefix(analysisFilePath + "WW/analysis/muHadNonIsoReweightAnalysis_WW");
  string WWNonIsoReweightHaddOutputFile(analysisFilePathOut + "muHadNonIsoReweightAnalysis_WW" + "_hadd" + WWSuffix);
  string WWAllPrefix(analysisFilePath + "WW/analysis/muHadAnalysis" + MTBin + "_WW");
  string WWAllHaddOutputFile(analysisFilePathOut + "muHadAnalysis" + MTBin + "_WW" + "_hadd" + WWSuffix);
...
// 		 graphNames1D, canvasNames2D, graphNames2D, nullBlindLow, nullBlindHigh);
  ...
  string sigVsBkgOutputFileNoHPSIsoCut(analysisFilePathOut + "results/sigVsBkg_muHadAnalysis" + MTBin + 
				       uncTag + tag19p7InvFb + outputVTag + fileExt);
  string sigVsBkgOutputFileNoHPSIsoCutNorm1(analysisFilePathOut + "results/sigVsBkg_muHadAnalysis" + MTBin + 
...
//   sigVsBkgNoHPSIsoCutInputFiles.push_back(WJetsToLNuAllHaddOutputFile);
  ...
  string dataVsMCOutputFile(analysisFilePathOut + "results/dataVsMC_muHadNonIsoAnalysis" + MTBin + 
			    tag19p7InvFb + outputVTag + fileExt);
  string dataVsMCOutputDiff(analysisFilePathOut + "results/dataVsMC_muHadNonIsoDifference" + MTBin + 
			    tag19p7InvFb + outputVTag + fileExt);
  string dataVsMCReweightOutputFile(analysisFilePathOut + 
...
// 					  dataMC);
  ...
  string sigVsBkgQCDFromDataOutputFile(analysisFilePathOut + 
				       "results/sigVsBkgQCDFromData_muHadIsoAnalysis" + MTBin + 
				       uncTag + tag19p7InvFb + outputVTag + fileExt);
  string sigVsBkgQCDFromDataOutputFile1(analysisFilePathOut + 
  ...
  string dataVsMCQCDFromDataOutputFile(analysisFilePathOut + 
				       "results/dataVsMCQCDFromData_muHadNonIsoAnalysis" + MTBin + 
				       tag19p7InvFb + outputVTag + fileExt);
  string dataVsMCQCDFromDataReweightOutputFile
    (analysisFilePathOut + "results/dataVsMCQCDFromData_muHadNonIsoReweightAnalysis" + MTBin + tag1 + 
     outputVTag + fileExt);
  ...
  string RegionBQCDVsMCOutputFile(analysisFilePathOut + 
  ...
  string RegionAQCDVsMCOutputFile(analysisFilePathOut + 
  ...
  */
  ...
  cout << "...Drell-Yan\n";
  string DYJetsToLLSearchVsControlOutputFile(analysisFilePathOut + 
  ...
  cout << "...ttbar\n";
  string TTJetsSearchVsControlOutputFile(analysisFilePathOut + "TTJets/analysis/isoVsNonIsoTaus" + MTBin + 
  					 tag1 + outputVTag + fileExt);
  ...
  cout << "...WZ\n";
  string WZSearchVsControlOutputFile(analysisFilePathOut + "WZ/analysis/isoVsNonIsoTaus" + MTBin + tag1 + 
  				     outputVTag + fileExt);
  ...
  cout << "...ZZ\n";
  string ZZSearchVsControlOutputFile(analysisFilePathOut + "ZZ/analysis/isoVsNonIsoTaus" + MTBin + tag1 + 
  				     outputVTag + fileExt);
  ...
  cout << "...WW\n";
  string WWSearchVsControlOutputFile(analysisFilePathOut + "WW/analysis/isoVsNonIsoTaus" + MTBin + tag1 + 
  				     outputVTag + fileExt);
  ...
  cout << "...non-isolated W data\n";
  string nonIsoWDataSearchVsControlOutputFile(analysisFilePathOut + 
