...
readFiles.extend([
    'file:/mnt/hadoop/store/user/kmtos/data1/kmtos/Wh1_Medium/EDM_files/data_no_selection_a11_v6.root'
    ])
...
process.CleanJets.outFileName = cms.string(
    '/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/v2/NMSSMSignal_MuProperties_Wh1_a11.root'
    )
...
process.highMTMuHadIsoTauAnalyzer = cms.EDAnalyzer(
    ...
    '/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/OUTPUT/Wh1/muHadIsoAnalysis_highMT_Wh1_a11_v2.root'
    ),
    tauTag = cms.InputTag('IsoBVetoFilter'),
...
process.lowMTMuHadIsoTauAnalyzer.outFileName = cms.string('/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/OUTPUT/Wh1/muHadIsoAnalysis_lowMT_Wh1_a11_v2.root')
...
process.highMTMuHadNonIsoTauAnalyzer.outFileName = cms.string(
    '/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/OUTPUT/Wh1/muHadNonIsoAnalysis_highMT_Wh1_a11_v2.root'
    )
...
process.lowMTMuHadNonIsoTauAnalyzer.outFileName = cms.string('/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/OUTPUT/Wh1/muHadNonIsoAnalysis_lowMT_Wh1_a11_v2.root')
...
process.highMTMuHadTauAnalyzer.outFileName = cms.string(
    '/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/OUTPUT/Wh1/muHadAnalysis_highMT_Wh1_a11_v2.root'
    )
...
process.lowMTMuHadTauAnalyzer.outFileName = cms.string('/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/OUTPUT/Wh1/muHadAnalysis_lowMT_Wh1_a11_v2.root')
...
process.output = cms.OutputModule(
    ...
    '/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/OUTPUT/Wh1/EDM/Wh1_a11_v2.root'
    )
    )
