...
process.CleanJets.outFileName = cms.string(
    '/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/z6/NMSSMSignal_MuProperties_Wh1_a7.root'
    )
...
process.highMTMuHadIsoTauAnalyzer = cms.EDAnalyzer(
    ...
    'file:/mnt/hadoop/store/user/kmtos/data1/kmtos/Wh1_Medium/muHadIsoAnalysis_highMT_Wh1_a7_z6.root'
    ),
    tauTag = cms.InputTag('IsoBVetoFilter'),
...
process.lowMTMuHadIsoTauAnalyzer.outFileName = cms.string('file:/mnt/hadoop/store/user/kmtos/data1/kmtos/Wh1_Medium/muHadIsoAnalysis_lowMT_Wh1_a7_z6.root')
...
process.highMTMuHadNonIsoTauAnalyzer.outFileName = cms.string(
    'file:/mnt/hadoop/store/user/kmtos/data1/kmtos/Wh1_Medium/muHadNonIsoAnalysis_highMT_Wh1_a7_z6.root'
    )
...
process.lowMTMuHadNonIsoTauAnalyzer.outFileName = cms.string('file:/mnt/hadoop/store/user/kmtos/data1/kmtos/Wh1_Medium/muHadNonIsoAnalysis_lowMT_Wh1_a7_z6.root')
...
process.highMTMuHadTauAnalyzer.outFileName = cms.string(
    'file:/mnt/hadoop/store/user/kmtos/data1/kmtos/Wh1_Medium/muHadAnalysis_highMT_Wh1_a7_z6.root'
    )
...
process.lowMTMuHadTauAnalyzer.outFileName = cms.string('file:/mnt/hadoop/store/user/kmtos/data1/kmtos/Wh1_Medium/muHadAnalysis_lowMT_Wh1_a7_z6.root')
...
process.output = cms.OutputModule(
    ...
    'file:/mnt/hadoop/store/user/kmtos/data1/kmtos/Wh1_Medium/EDM_files/Wh1_a7_z6.root'
    )
    )
