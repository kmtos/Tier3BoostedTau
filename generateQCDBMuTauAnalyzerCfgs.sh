...
EDMOutputFilePrefix="file:/mnt/hadoop/store/user/kmtos/data1/`whoami`/QCDBMu/EDM_files/"
...
echo \"generateQCDBMuTauAnalyzerCfgs.sh\"
condor_submit  Csubmit_\$jobName
done
exit 0" >> submitQCDBMuTauAnalyzerJobs.sh
...
for sample in "15to30" "30to50" "50to150" "150"
  ...
  for cut in Iso NonIso NonIsoReweight
    ...
    if [ "\$cut" != "NonIso" ] || [ $reweightOnly -eq 0 ]
        then
        cp -f /home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/muHad\${cut}Analysis_QCDBMu_pt\${sample}_${version}.root /mnt/hadoop/store/user/kmtos/data1/`whoami`/QCDBMu/analysis/
        rm  /home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/muHad\${cut}Analysis_QCDBMu_pt\${sample}_${version}.root
    fi
  done
done
...
for sample in "15to30" "30to50" "50to150" "150"
  do
  cp -f  /home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/muHadAnalysis_QCDBMu_pt\${sample}_${version}.root /mnt/hadoop/store/user/kmtos/data1/`whoami`/QCDBMu/analysis/
  rm  /home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/muHadAnalysis_QCDBMu_pt\${sample}_${version}.root
done
