...
process.CleanJets.outFileName = cms.string(
    'file:/home/kmtos/NMSSM_Analysis/CMSSW_5_3_11/src/BoostedTauAnalysis/TauAnalyzer/test/v1/NMSSMSignal_MuProperties_gg_a11.root'
    )
...
process.highMTMuHadIsoTauAnalyzer = cms.EDAnalyzer(
    ...
    'file:/mnt/hadoop/store/user/kmtos/data1/kmtos/gg/muHadIsoAnalysis_highMT_gg_a11_v1.root'
    ),
    tauTag = cms.InputTag('IsoBVetoFilter'),
...
process.lowMTMuHadIsoTauAnalyzer.outFileName = cms.string('file:/mnt/hadoop/store/user/kmtos/data1/kmtos/gg/muHadIsoAnalysis_lowMT_gg_a11_v1.root')
...
process.highMTMuHadNonIsoTauAnalyzer.outFileName = cms.string(
    'file:/mnt/hadoop/store/user/kmtos/data1/kmtos/gg/muHadNonIsoAnalysis_highMT_gg_a11_v1.root'
    )
...
process.lowMTMuHadNonIsoTauAnalyzer.outFileName = cms.string('file:/mnt/hadoop/store/user/kmtos/data1/kmtos/gg/muHadNonIsoAnalysis_lowMT_gg_a11_v1.root')
...
process.highMTMuHadTauAnalyzer.outFileName = cms.string(
    'file:/mnt/hadoop/store/user/kmtos/data1/kmtos/gg/muHadAnalysis_highMT_gg_a11_v1.root'
    )
...
process.lowMTMuHadTauAnalyzer.outFileName = cms.string('file:/mnt/hadoop/store/user/kmtos/data1/kmtos/gg/muHadAnalysis_lowMT_gg_a11_v1.root')
...
process.output = cms.OutputModule(
    ...
    'file:/mnt/hadoop/store/user/kmtos/data1/kmtos/gg/EDM_files/gg_a11_v1.root'
    )
    )
